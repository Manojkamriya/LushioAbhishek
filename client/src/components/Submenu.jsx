...
function MenSubmenu(){
  ...
  return(
    ...
    <img className='res-submenu-image' src='./Images/card-image-6.webp' alt=''/>
...
function WomenSubmenu(){
  return(
    ...
    <img className='res-submenu-image' src='./Images/card-image-2.webp' alt=''/>
...
function AccesoriesSubmenu(){
  return(
    ...
    <ul>
            ...
            <li><Link to='/'>Shakers</Link></li>
            <li><Link to='/'>Wrist Band</Link></li>
            <li><Link to='/'>Deadlift Band</Link></li>
            <li><Link to='/'>New Drop</Link></li>
            <li><Link to='/'>Comming Soon</Link></li>
            <li><Link to='/'>Restock</Link></li>
            <li><Link to='/'>Best Seller</Link></li>
    ...
    <img className='res-submenu-image' src='./Images/assets/product_303.webp' alt=''/>
...
<ul className='res-navbar-headings-list'>
  <li onClick={()=>setMenu("Men")}><Link to='/men'>Men</Link></li>
  <li onClick={()=>setMenu("Women")}><Link to='/women'>Women</Link></li>
  <li onClick={()=>setMenu("Accessories")}><Link to='/accessories'>Accessories</Link></li>
</ul>
